...
Here you can find an exerpt of my private hobby projects of the last years:
  ...
  |:---:   | :---: | :---: |  :--- | :---
   | [PyHandlebars](https://github.com/sukram42/pyhandlebars) | A Python library to bring a typed version of handlebars.js to the Python world. | 2026 | The library should help as template engine in Python. PyHandlebars can help, formatting and templating prompt, configuration files, webpages or anything else which has to be templated. The library is based on [handlebars-rust](https://github.com/sunng87/handlebars-rust?tab=readme-ov-file) | Python, Rust, Pydantic |
  | [Log a ride](https://www.logaride.app) [[www.logaride.app](https://www.logaride.app)] | A Multitenant app for tracking kilometers of a shared car pool. | 2025 - 2026 | When sharing a car, splitting costs and tracking kilometer, can get cumbersome. This app should help to reduce the pain of sharing a car. | TypeScript, Supabase, ReactJS, Postgres, Vite, LLMs, Capacitor | 
